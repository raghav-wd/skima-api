...
class simple_html_dom_node
{
    ...
    function outertext()
    {
        ...
        if (is_object($debug_object)) {
            ...
            $debug_object->debug_log(
                1,
                "Innertext of tag: " . $this->tag . $text
            );
        }
...
class simple_html_dom
{
    ...
    function load_file()
    {
        ...
        if (
            ($doc = call_user_func_array("file_get_contents", $args)) !== false
        ) {
            $this->load($doc, true);
        } else {
            return false;
    ...
    protected function parse_charset()
    {
        ...
        if (empty($charset)) {
            ...
            if (function_exists("mb_detect_encoding")) {
                 ...
                 * to stay compatible.
                 */
                $encoding = mb_detect_encoding($this->doc, [
                    "UTF-8",
                    "CP1252",
                    "ISO-8859-1",
                ]);
    ...
    protected function read_tag()
    {
        ...
        $this->char =
            ++$this->pos < $this->size ? $this->doc[$this->pos] : null; // next
        ...
        if (isset($this->optional_closing_tags[$tag_lower])) {
            ...
            while (
                isset(
                    $this->optional_closing_tags[$tag_lower][
