...
$data =
    "sharedBy=srm_university&appLinkName=academia-academic-services&zccpn=bts&viewLinkName=WELCOME&&urlParams=%7B%7D&isPageLoad=true";
$headers = ["Cookie: " . $cookieKey];
